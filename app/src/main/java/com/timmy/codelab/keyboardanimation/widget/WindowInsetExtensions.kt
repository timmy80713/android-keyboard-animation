package com.timmy.codelab.keyboardanimation.widget
...
fun View.doOnWindowInsetsChanged(
    ...
    if (listenToAnimation.not()) return

    val insetsAnimationCallback = object : WindowInsetsAnimationCompat.Callback(dispatchMode) {
